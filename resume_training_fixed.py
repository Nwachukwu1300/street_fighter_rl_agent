...
Run with: caffeinate -d diambra run -s=4 python resume_training_fixed.py
"""
print("Starting resume script...")
...
def train_phase_continue(phase_name, difficulty, total_steps, checkpoint_path,
                         step_ratio=6, checkpoint_dir="./models_ultimate/"):
    ...
    # Create environments using DIAMBRA's native function
